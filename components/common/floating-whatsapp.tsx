...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex items-center gap-2.5 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-xl ring-4 ring-emerald-500/20 transition-all hover:scale-105 hover:bg-[#20bd5a] hover:shadow-emerald-500/30 focus:outline-none focus:ring-4 focus:ring-emerald-500/50"
    >
