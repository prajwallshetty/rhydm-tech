...
import { conditionShort, discountPercent, formatPrice } from "@/lib/format";
            ...
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div className="max-w-2xl">
                ...
                <h1 className="mt-4 text-4xl font-black tracking-tight text-slate-900 sm:text-5xl">
                  Today&rsquo;s best savings
                </h1>
                <p className="mt-3 text-base leading-relaxed text-slate-500">
                  Ranked by percentage saved against original list price. Every
                  unit keeps its full warranty — prices hold while stock lasts,
              ...
              <div className="flex flex-col justify-center p-8 sm:p-10">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-semibold text-slate-500">
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    {top.warrantyMonths}-month warranty
                  </span>
                  <span className="inline-flex items-center gap-1.5">
            ...
            <FadeIn>
              <div className="flex items-end justify-between gap-4">
                ...
                <p className="text-sm font-semibold text-slate-500">
                  {rest.length} more {rest.length === 1 ? "deal" : "deals"}
                </p>
              </div>
            </FadeIn>
        ...
        {deals.length === 0 && (
          <div className="rounded-[32px] border border-dashed border-slate-300 bg-slate-50 px-8 py-20 text-center">
            ...
            <p className="mx-auto mt-2 max-w-sm text-sm text-slate-500">
              Check back soon — corporate returns land weekly and the best
              units go on clearance first.
            </p>
            <Link
